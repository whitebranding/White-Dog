...
const create_back_element_wrapper = () => {
...
const mob_dropdown_handler = (e, back = false) => {
    e.preventDefault();
    if ( back ) {
...
if (typeof mob_dropdown_handler !== 'undefined') {
  window.mob_dropdown_handler = mob_dropdown_handler;
}
})();